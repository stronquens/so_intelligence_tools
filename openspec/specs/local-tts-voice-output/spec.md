# local-tts-voice-output Specification

## Purpose

Define platform-aware local TTS voice-output paths for reading visible assistant activity aloud while keeping text workflows usable when speech is disabled.
